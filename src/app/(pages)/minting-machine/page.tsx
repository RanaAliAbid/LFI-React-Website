					...
					<Row className="justify-content-center align-items-center">
						<Col md="6" className="">
							<div className="infoText text-center">
								...
								<Link className="compareLink" href={"/compare-spec"}>Compare</Link>
							</div>
						</Col>
					</Row>
				</Container>
					...
					<Row className="justify-content-center align-items-center">
						<Col md="6" className="">
							<div className="infoText text-center">
								...
								<p>
									{" "}
									<span> Mint </span> your way to a brighter future{" "}
								</p>
								<h3>
									{" "}
									Designed to provide you with a simple and hassle-free way to
									create LFi tokens right from the comfort of your own home{" "}
								</h3>
								<Button
									as="a"
									variant="primary"
									target="_blank"
									href="https://white-paper.lfi.io/layer-2-iop-and-hardware/hardware/miner-xlfi1000"
								>
									Explore More
								</Button>
								<Link className="compareLink" href={"/compare-spec"}>Compare</Link>
					...
					<Row className="justify-content-center align-items-center">
						<Col md="6" className="">
							<div className="infoText text-center">
								...
								<p>
									{" "}
									Discover new possibilities and unlock your financial future{" "}
								</p>
								<h3>
									{" "}
									Access a range of exciting features and functions that will
								...
								<Button
									...
									variant="primary"
									target="_blank"
									href="https://white-paper.lfi.io/layer-2-iop-and-hardware/hardware/miner-plus-xlfi5000"
								>
									Explore More
								</Button>
								<Link className="compareLink" href={"/compare-spec"}>Compare</Link>
